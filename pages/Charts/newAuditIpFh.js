...
import DownloadTemplateButton from "components/MKButton/DownloadTemplateButton";
//const now = new Date();
    ...
    const fetchData = () => {
      if (switchPosition === "left") {
        ...
        axiosInstance
          ...
          .catch((error) => console.error("Error fetching data:", error));
        axiosInstance
          .get("/audits/api/auditipfh/evolutiontauxdecoherence")
          .then((response) => setData(response.data))
          .catch((error) => console.error("Error fetching data:", error));
        axiosInstance
          .get("/audits/api/auditipfh/repartitionporteurtdjcdr")
      ...
      >
        <div style={{ backgroundColor: "#0055a4" }}>
          <MKTypography
            ...
            justifyContent=""
          >
            Audit IP FH <GeneralFileInput csrfTokenUrl="/fluxoa/api/get_csrf_token/" 
  uploadUrl="audits/api/uploadexcelipfh/" /> 
<DownloadTemplateButton />
        ...
        >
          ...
          <div style={{ fontSize: "18px", marginTop: "30px" }}></div>

          <div style={{ fontSize: "18px", marginTop: "25px", marginLeft: "900px" }}>
        ...
        <Container maxWidth="XXl">
          <Card sx={{ marginBottom: "20px", backgroundColor: "rgba(255, 255, 255, 0.4)" }}>
            ...
            <Grid container spacing={3} alignItems="center" justifyContent="center">
              <Grid item xs={12} sm={3} style={{ margin: 0 }}>
                ...
                <div style={{ marginBottom: "20px" }}>
                  ...
                  title="IP Existant BDE Uniquement"
                    ...
                    positive={
                      nbrofIncoherence ? nbrofIncoherence.percentage_ip_bde_uniquement > 0 : false}
                  />
                </div>
              </Grid>
              ...
              <Grid item xs={12} sm={3} style={{ margin: 0 }}>
                {switchPosition === "right" && <div style={{ marginBottom: "20px" }}></div>}
                {switchPosition === "left" && <div style={{ marginBottom: "20px" }}></div>}

                <div style={{ marginBottom: "20px" }}>
                  <AuditIpFhCard
                    title="IP concernée par un SWAP à venir"
                    description="du Parc"
                ...
                <div style={{ marginBottom: "20px" }}>
                  {switchPosition === "left" && (
                    <AuditIpFhCard
                      title="IP concernée par un nouveau déploiement"
                      description="du Parc"
                      difference={
