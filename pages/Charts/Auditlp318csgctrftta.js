...
const PageCsgCtrFtta = () => {
  ...
  useEffect(() => {
    axiosInstance
      .get("/audits/api/auditcsgfttactr/tauxdecoherence")
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get("/audits/api/auditcsgfttactr/repartitioncsg")
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgfttactr/repartionincoherence")
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgfttactr/evolutiontauxdecoherence")
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get("/audits/api/auditcsgfttactr/")
      .then((response) => {
...
const columnsCSGCTRFTTA = [
    ...
    "ETAT_BDR_BDE","Lien_IP_Interco_CTR1","Routage_Lien_IP_CTR1","Lien_IP_SUP_CTR1","Routage_Lien_IP_SUP_CTR1",
    "Lien_AGG_CTR1","Routage_Lien_AGG_CTR1","Lien_ZT_CTR1","Routage_Lien_ZT_CTR1",
    "Lien_IP_INTERCO_CTR2","Routage_Lien_IP_INTERCO_CTR2","Lien_IP_SUP_CTR2","Routage_Lien_IP_INTERCO_SUP_CTR2",
    "Lien_ZT_CTR2","Routage_Lien_ZT_CTR2","Lien_AGG_CTR2","Routage_Lien_AGG_CTR2","Lien_LO_CTR1","Lien_LO_CTR2",
    "LAG","VLAN","Adresse_IP_Interco","Adresse_IP_SUP","Adresse_IP_Loopback0_1","Adresse_IP_Radio",
    "Modelisation_des_Liens","Port","Routage_des_Liens","ETAT_CSG","Date_column","Usine_Prod"];
      ...
      >
        <div style={{ backgroundColor: "#0055a4" }}>
          <MKTypography variant="h1" align="center" mb={0} mt={1} sticky color="white">
            Audit CSG CTR VIA FTTA <GeneralFileInput csrfTokenUrl="/fluxoa/api/get_csrf_token/" 
  uploadUrl="audits/api/uploadcsvcsg" />
         <DownloadTemplateButtonCSG columns={columnsCSGCTRFTTA} filename="Input Template" />
          </MKTypography>
