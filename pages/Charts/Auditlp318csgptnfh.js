...
const PageCsgPtn = () => {
  ...
  useEffect(() => {
    axiosInstance
      .get("/audits/api/auditcsgptn/tauxdecoherence")
  ...
  useEffect(() => {
    axiosInstance
      .get("/audits/api/auditcsgptn/repartitioncsg")
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get("/audits/api/auditcsgptn/repartionincoherence")
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgptn/evolutiontauxdecoherence")
      ...
      >
        <div style={{ backgroundColor: "#0055a4" }}>
          <MKTypography variant="h1" align="center" mb={0} mt={1} sticky color="white">
            Audit CSG PTN VIA FH <GeneralFileInput csrfTokenUrl="/fluxoa/api/get_csrf_token/" 
