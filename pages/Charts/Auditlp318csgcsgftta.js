...
const PageCsgPtn = () => {
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get("/audits/api/auditcsgfttacsg/tauxdecoherence")
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgfttacsg/repartitioncsg")
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgfttacsg/repartionincoherence")
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgfttacsg/evolutiontauxdecoherence")
  ...
  const columnsCSGPTNFTTA = [
    ...
    "Routage_Lien_AGG","Lien_ZT","Routage_Lien_ZT","LAG","VLAN","Adresse_IP_Interco","Adresse_IP_SUP",
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get("/audits/api/auditcsgfttacsg/")
      .then((response) => {
      ...
      >
        <div style={{ backgroundColor: "#0055a4" }}>
          <MKTypography variant="h1" align="center" mb={0} mt={1} sticky color="white">
            Audit CSG CSG VIA FTTA <GeneralFileInput csrfTokenUrl="/fluxoa/api/get_csrf_token/" 
  uploadUrl="audits/api/uploadcsvcsg" />
          <DownloadTemplateButtonCSG columns={columnsCSGPTNFTTA} filename="Input Template" />
