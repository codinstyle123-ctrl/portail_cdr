...
import DownloadTemplateButton from "components/MKButton/DownloadTemplateButtonLp71_2_radio";
...
import { OverviewTotalProfit } from "../../overview/overview-total-radio-profit";
...
const PageLp71_2 = () => {
  ...
  const fetchData = async () => {
    ...
    setError(null);
    try {
      const response = await axiosInstance.get("/controle/lp71_2_radio/statistics/");
      ...
      <div style={{ backgroundColor: "#0055a4" }}>
        <div style={{ marginLeft: "6%", marginRight: "6%", padding: "8px" }}>
          <Grid container alignItems="center" justifyContent="space-between" sx={{ px: 2 }} >
            ...
            <Grid item>
              <MKTypography variant="h3" color="white" sx={{ fontWeight: "bold", mb: 0.5 }} >
                LP71.2 Migrations des sites distants vers CSG : Radio
              </MKTypography>
            </Grid>
            <Grid item display="flex" >
              <Box item alignItems="center">
                <GeneralFileInput
                  ...
                  uploadUrl="controle/lp71_2_radio/upload"
          ...
          >
            <Grid container spacing={1}> {/* Spacing réduit de 2 à 1 */}
              ...
              <Grid item xs={12} sm={6} md={3}>
                ...
                <MKTypography variant="body2" align="center" sx={{ fontSize: "1rem" }}>
                  {auditData?.general_statistics?.total_equipment} équipements radio
                </MKTypography>
              </Grid>
              <Grid item xs={12} sm={4}>
                ...
                <MKTypography variant="body2" align="center" sx={{ fontSize: "1rem" }}>
                  ...
                  {auditData?.coherence_breakdown?.total_nok} équipements radio
                </MKTypography>
              </Grid>
              <Grid
                item
              ...
              >
                <OverviewTotalProfit sx={{ height: "100%" }} value="" />
              </Grid>
