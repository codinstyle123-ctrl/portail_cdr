...
export const HorizentalBarChart = (props) => {
  ...
  const chartSeries = [
    {
      name: "ATR avec 1 Incohérence",
      data: [chartData.one_nok_count || 0],
    },
    {
      name: "ATR avec 2 Incohérences",
      data: [chartData.two_nok_count || 0],
    },
    {
      name: "ATR avec 3 Incohérences ou plus",
  ...
  return (
    ...
    <CardHeader title="Volume de ATR par Nombre D'incoherence" />
    <CardContent>
        {isAllZero ? (
          <Alert severity="success">
            <AlertTitle>Aucune incohérence détectée</AlertTitle>
            Félicitations, toutes les ATR sont conformes !
          </Alert>
        ) : (
          <Chart
            height={350}
