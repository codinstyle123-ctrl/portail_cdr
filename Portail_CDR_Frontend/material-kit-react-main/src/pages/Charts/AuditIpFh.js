    ...
    const fetchData = () => {
      if (switchPosition === "left") {
        ...
        axiosInstance
          ...
          .catch((error) => console.error("Error fetching data:", error));
        axiosInstance
          .get("/audits/api/auditipfh/incoherencetdjcdr")
      ...
      if (switchPosition === "right") {
        ...
        axiosInstance
          ...
          .catch((error) => console.error("Error fetching data:", error));
        axiosInstance
          .get("/audits/api/auditipfh/incoherencetdjosa")
          .then((response) => setNbrofIncoherence(response.data))
          .catch((error) => console.error("Error fetching data:", error));
        axiosInstance
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "18px", color: "red", marginLeft: "100px", marginTop: "30px" }}>
            ❌
          </div>
          <div style={{ fontSize: "18px", marginTop: "30px" }}> FHT Incoherent</div>
          ...
          <div style={{ fontSize: "18px", marginTop: "25px", marginLeft: "135px" }}>
            ...
            <Grid container spacing={3} alignItems="center" justifyContent="center">
              <Grid item xs={12} sm={3} style={{ margin: 0 }}>
                <div style={{ marginBottom: "20px" }}>
                  <AuditIpFhCard
                    title="FHT avec incohérence BDR​"
                    description="du Parc"
                    difference={nbrofIncoherence ? nbrofIncoherence.percentage_incoherence_bdr : 0}
                    positive={
                      nbrofIncoherence ? nbrofIncoherence.percentage_incoherence_bdr > 0 : false
                    }
                    value={nbrofIncoherence ? nbrofIncoherence.fht_incoherence_bdr_count : 0}
                  />
                </div>
                <div style={{ marginBottom: "20px" }}>
                  <AuditIpFhCard
                    title="FHT avec incohérence BDE​"
                    description="du Parc"
                    difference={nbrofIncoherence ? nbrofIncoherence.percentage_incoherence_bde : 0}
                    positive={
                      nbrofIncoherence ? nbrofIncoherence.percentage_incoherence_bde > 0 : false
                    }
                    value={nbrofIncoherence ? nbrofIncoherence.fht_incoherence_bde_count : 0}
                  />
                </div>
                <div style={{ marginBottom: "20px" }}>
                  <AuditIpFhCard
                    title="FHT avec incohérence dans BDR ou BDE ​"
                    description="du Parc"
                    difference={
                      nbrofIncoherence ? nbrofIncoherence.percentage_incoherence_bdr_ou_bde : 0
                    }
                    positive={
                      nbrofIncoherence
                        ? nbrofIncoherence.percentage_incoherence_bdr_ou_bde > 0
                        : false
                    }
                    value={nbrofIncoherence ? nbrofIncoherence.fht_incoherence_bdr_ou_bde_count : 0}
                  />
                </div>
              </Grid>
     ...
     <div style={{ marginBottom: "20px" }}>
          ...
          <div style={{ marginBottom: "20px" }}>
           ...
           <Grid xs={12} md={8} lg={6}>
            ...
            <Grid xs={12} md={8} lg={6}>
              {chartSeriesdatabdroubde && chartSeriesdatabdroubde.length > 0 && labelsbdroubde && labelsbdroubde.length > 0 ? (
                <DonutChartRepartitionIncoherence
