...
const PageCsgFhCsg = () => {
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgfhcsg/tauxdecoherence")
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgfhcsg/repartitioncsg")
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgfhcsg/repartionincoherence")
  ...
  useEffect(() => {
    // Make an API request to your Django backend using Axios
    axiosInstance
      .get("/audits/api/auditcsgfhcsg/evolutiontauxdecoherence")
      ...
      >
        <div style={{ backgroundColor: "#0055a4" }}>
          <MKTypography variant="h1" align="center" mb={0} mt={1} sticky color="white">
            Audit CSG CSG VIA FH <GeneralFileInput csrfTokenUrl="/fluxoa/api/get_csrf_token/" 
  uploadUrl="audits/api/uploadcsvcsg" />
<DownloadTemplateButtonCSG columns={columnsCSGCTRFH} filename="Input Template" />
